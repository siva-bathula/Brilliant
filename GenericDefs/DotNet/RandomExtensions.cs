...
namespace GenericDefs.DotNet
{
    ...
    {
        /// <summary>
        ///   Generates normally distributed numbers. Each operation makes two Gaussians for the price of one, and apparently they can be cached for better performance.
        /// </summary>
        /// <param name="r"></param>
        ...
        public static IEnumerable<T> RandomPermutation<T>(this Random random, IEnumerable<T> sequence, int start, int end)
        {
        ...
        /// <returns></returns>
        public static List<int> Permutation(this Random rand, int n, int k)
        {
