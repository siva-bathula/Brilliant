...
namespace GenericDefs.OtherProjects
{
    ...
    public static class SudokuSolver
    {
        ...
        /// <summary>Used for debugging/ printing final answer</summary>
        public static Dictionary<string, string> PrintBoard(Dictionary<string, string> values)
        {
        ...
        public static string ConcatSolution(Dictionary<string, string> values, string[] keys)
        {
            if (values == null) throw new Exception("Solution dictionary cannot be null.");
            string retVal = string.Empty;
            foreach (string key in keys)
            {
                if (!values.ContainsKey(key)) { throw new ArgumentException("Key not found. Key : " + key); }
                retVal += values[key];
            }
